...
export function Dashboard() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-cyan-50 via-indigo-50 to-violet-50 p-8">
      <div className="w-full max-w-4xl">
        {/* Header */}
        <div className="mb-12 text-center">
          <h1 className="mb-4 bg-gradient-to-r from-cyan-600 to-indigo-600 bg-clip-text text-6xl font-bold text-transparent">
            みつもりくん
          </h1>
        ...
        <div className="mb-8 grid gap-6 md:grid-cols-2">
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              <div className="rounded-full bg-cyan-100 p-3 group-hover:bg-cyan-200">
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              <div className="rounded-full bg-indigo-100 p-3 group-hover:bg-indigo-200">
        ...
        <div className="mt-12 grid gap-4 text-center md:grid-cols-3">
          <div className="rounded-lg bg-white/60 p-6 backdrop-blur-sm">
            <div className="mb-2 text-3xl font-bold text-cyan-600">AI</div>
            <p className="text-sm text-gray-700">自動マッチング</p>
          </div>
          <div className="rounded-lg bg-white/60 p-6 backdrop-blur-sm">
            <div className="mb-2 text-3xl font-bold text-indigo-600">100%</div>
